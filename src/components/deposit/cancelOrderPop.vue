  ...
  <teleport v-if="modelValue" to="body">
    <transition name="modal-fade">
      <div class="fixed inset-0 flex items-center justify-center z-[999] overflow-hidden">
        ...
        >
          <div
            class="px-4 py-6 w-[300px] sm:w-[368px] h-[327px] sm:h-[352px] rounded-xl modal-container bg-bg-2"
          >
            ...
            <div class="mt-4 h-[156px] w-full p-3 rounded-lg bg-bg-6 overflow-y-auto">
              <div
            ...
            <button
              ...
              class="mt-6 h-12 w-full rounded-lg text-text-4 text-[14px] font-bold flex items-center justify-center"
