<template>
  <div class="modules mb-4" v-for="(item, index) in [1, 2, 3, 4, 5]" :key="index">
      ...
      <div class="grid grid-flow-col auto-cols-[30.25%] gap-2">
        <div v-for="(item, index) in [1, 2, 3, 4, 5, 6]" :key="index">
          <a
            ...
            >
              <div class="icon size-4 fill-alw_white">
              ...
              <span class="text-xs font-semibold text-alw_white">2191</span>
            </div></a
          >
        </div>
      </div>
