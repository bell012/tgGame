...
const mysteryBoxAdapter: TicketGameAdapter = {
  gameId: 'mystery_box',
  component: MysteryBoxGrid,
  resolveProps: () => ({}),
  resolveListeners: () => ({})
}
...
export function isTicketGameImplemented(gameId: TicketGameId): boolean {
  return gameId === 'lucky_spin' || gameId === 'lucky_red_envelope' || gameId === 'mystery_box'
}
