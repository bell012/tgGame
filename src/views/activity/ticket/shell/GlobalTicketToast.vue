...
import TicketModalHeader from '../layout/TicketModalHeader.vue'
import TicketWinnerTicker from '../layout/TicketWinnerTicker.vue'
import TicketVoucherFooter from '../layout/TicketVoucherFooter.vue'
