<template>
  <div class="fixed inset-0 flex min-h-0 flex-col overflow-hidden bg-bg-1">
    ...
    <div class="my-profile-mobile-scroll flex-1 min-h-0 overflow-y-auto bg-bg-1">
          ...
          <div class="flex items-start justify-between">
            ...
            <div class="flex flex-col items-center text-center">
              <div class="relative h-[60px] w-[60px] overflow-visible">
                <div
                  class="absolute overflow-hidden rounded-full inset-0 border-4 border-opacity-15"
                >
