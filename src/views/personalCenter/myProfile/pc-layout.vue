              ...
              <div class="relative h-[60px] w-[60px] overflow-visible">
                <div
                  :class="[
                    ...
                    selectedAvatarFrameImage ? 'inset-[4px]' : 'inset-0 border-2 border-icon-2'
                  ]"
                >
                ...
                />
                <span
                  class="absolute bottom-[-6px] left-1/2 z-10 flex h-[20px] min-w-[44px] -translate-x-1/2 items-center justify-center rounded border border-icon-1 bg-text-2 px-0.5 text-xs font-[700] text-text-1"
