<template>
  <section class="flex flex-col gap-[10px]">
    <section class="overflow-hidden rounded-[10px] bg-bg-2">
      <div class="relative flex h-[40px] items-center justify-between px-[14px]">
        ...
        >
          ...
          <span class="flex h-[20px] w-[20px] items-center justify-center rounded-[6px] bg-opacity-10">
    ...
    <section v-if="props.rewardHistoryRows.length > 0" class="overflow-hidden rounded-[10px] bg-bg-2">
...
import type { ReferralDetailsRewardHistoryRow } from '../shared'
