  ...
  <div v-else class="flex flex-col gap-2 px-0.5 pb-6 mt-3.5">
    ...
    >
      <div class="px-3.5">
        ...
        <div class="bg-bg-4 py-2.5 px-3 rounded-lg mb-2.5">
          <div class="flex justify-between items-center self-stretch">
            <div>Actual Turnover</div>
            <div>+1000</div>
          </div>
          <div class="flex justify-between items-center self-stretch mt-2.5">
            <div>Required Turnover</div>
            <div>+1000</div>
          </div>
        </div>
      </div>
