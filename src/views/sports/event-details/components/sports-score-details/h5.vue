    ...
    <div class="flex items-center gap-2">
      ...
      >
        <button
          ...
          class="inline-flex h-[33px] shrink-0 items-center rounded-lg border-0 px-3 text-[13px] font-normal transition-colors"
          :class="activeFilter === tab.key ? 'bg-theme-primary text-text-4' : 'bg-bg-2 text-text-1'"
