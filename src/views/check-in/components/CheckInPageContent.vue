<template>
      ...
      <div class="mx-auto flex w-[476px] flex-col items-center px-[12px] pt-[24px]">
        ...
        <section class="mt-[24px] flex w-full flex-col items-center gap-[24px]">
          ...
          <div class="flex w-full items-center justify-center">
            <p class="text-[16px] font-[400] leading-[19px] text-common-100">
          ...
          <div class="grid w-full grid-cols-2 gap-[12px]">
            ...
            >
              <!-- PC 奖励图标外壳 -->
              <div
                class="flex h-[46px] w-[40px] shrink-0 items-center justify-center rounded-[6px] border border-white/10"
                :style="reward.iconShellStyle"
              >
                <img :src="reward.icon" alt="" class="h-[24px] w-[24px] object-contain" />
              </div>
              ...
              <div class="min-w-0">
                ...
                <div class="mt-[4px] flex items-center gap-[2px]">
                  <img :src="reward.icon" alt="" class="h-[20px] w-[20px] object-contain" />
                  <p
  ...
  <section v-else class="relative h-[812px] w-full max-w-[375px] overflow-hidden text-common-100">
    ...
    <section class="absolute left-[20px] top-[481px] z-20 w-[335px]">
      <!-- H5 奖励区标题 -->
      <p class="text-[14px] font-[700] leading-[17px] text-common-100">
        {{ t('checkIn.rewardSectionTitle') }}
      </p>

      <!-- H5 奖励分行列表 -->
      <div class="mt-[7px] flex flex-col gap-[7px]">
        <!-- H5 奖励单行 -->
        <div
        ...
        >
          ...
          >
            <!-- H5 奖励图标外壳 -->
            <div
              class="flex h-[35px] w-[31px] shrink-0 items-center justify-center rounded-[5px] border border-white/10"
              :style="reward.iconShellStyle"
            >
              <img :src="reward.icon" alt="" class="h-[18px] w-[18px] object-contain" />
            </div>
            ...
            <div class="min-w-0">
              ...
              <div class="mt-[2px] flex items-center gap-[1px]">
                <img :src="reward.icon" alt="" class="h-[13px] w-[13px] object-contain" />
